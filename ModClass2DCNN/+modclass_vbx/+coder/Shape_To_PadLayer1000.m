classdef Shape_To_PadLayer1000 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = modclass_vbx.coder.Shape_To_PadLayer1000(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = modclass_vbx.Shape_To_PadLayer1000(cgInstance.Name);
            ...
            this_ml.CNN1_Split_split = cgInstance.CNN1_Split_split;
            this_ml.CNN1_Pad_value = cgInstance.CNN1_Pad_value;
        end
    end

    methods
        function this = Shape_To_PadLayer1000(mlInstance)
            ...
            this.CNN1_Split_split = mlInstance.CNN1_Split_split;
            this.CNN1_Pad_value = mlInstance.CNN1_Pad_value;
        end

        function [CNN1_Pad] = predict(this, InputLayer__)
            if isdlarray(InputLayer__)
                InputLayer_ = stripdims(InputLayer__);
            else
                InputLayer_ = InputLayer__;
            end
            InputLayerNumDims = 4;
            InputLayer = modclass_vbx.coder.ops.permuteInputVar(InputLayer_, [4 3 1 2], 4);

            [CNN1_Pad__, CNN1_PadNumDims__] = Shape_To_PadGraph1000(this, InputLayer, InputLayerNumDims, false);
            CNN1_Pad_ = modclass_vbx.coder.ops.permuteOutputVar(CNN1_Pad__, [3 4 2 1], 4);

            CNN1_Pad = dlarray(single(CNN1_Pad_), 'SSCB');
        end
        ...
        function [CNN1_Pad, CNN1_PadNumDims1001] = Shape_To_PadGraph1000(this, InputLayer, InputLayerNumDims, Training)
            ...
            % Shape:
            [CNN1_InputShapeInt, CNN1_InputShapeIntNumDims] = modclass_vbx.coder.ops.onnxShape(InputLayer, InputLayerNumDims, 0, InputLayerNumDims+1);
            ...
            % Relu:
            X1000 = dlarray(modclass_vbx.coder.ops.extractIfDlarray(CNN1_Sub1));
            Y1001 = relu(X1000);
            CNN1_ReluInt = modclass_vbx.coder.ops.extractIfDlarray(Y1001);
            ...
            % Split:
            [CNN1_BCPadding, CNN1_totalPaddingNee, CNN1_totalPaddingN_5, CNN1_BCPaddingNumDims, CNN1_totalPaddingNeeNumDims, CNN1_totalPaddingN_5NumDims] = modclass_vbx.coder.ops.onnxSplit13(CNN1_Relu, 0, this.CNN1_Split_split, 3, CNN1_ReluNumDims);
            ...
            % Concat:
            [CNN1_paddingSize, CNN1_paddingSizeNumDims] = modclass_vbx.coder.ops.onnxConcat(0, {this.Vars.CNN1_Zero, this.Vars.CNN1_Zero, CNN1_totalPaddingN_3, CNN1_totalPaddingN_8, this.Vars.CNN1_Zero, this.Vars.CNN1_Zero, CNN1_totalPaddingN_1, CNN1_totalPaddingN_6}, [this.NumDims.CNN1_Zero, this.NumDims.CNN1_Zero, CNN1_totalPaddingN_3NumDims, CNN1_totalPaddingN_8NumDims, this.NumDims.CNN1_Zero, this.NumDims.CNN1_Zero, CNN1_totalPaddingN_1NumDims, CNN1_totalPaddingN_6NumDims]);

            % Cast:
            CNN1_paddingSizeInt = cast(int64(modclass_vbx.coder.ops.extractIfDlarray(CNN1_paddingSize)), 'like', CNN1_paddingSize);
            CNN1_paddingSizeIntNumDims = CNN1_paddingSizeNumDims;

            % Pad:
            [CNN1_Pad, CNN1_PadNumDims] = modclass_vbx.coder.ops.onnxPad(InputLayer, CNN1_paddingSizeInt, this.CNN1_Pad_value, 'constant', [0:InputLayerNumDims]', InputLayerNumDims);
